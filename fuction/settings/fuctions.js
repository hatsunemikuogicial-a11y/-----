...
const banner2 = cfonts.render((`Canal Oficial: https://whatsapp.com/channel/0029VbC2606K0IBc9fNug21g\nCreador: Yoel`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`𝑯ᴀᴛꜱᴜɴᴇ ᴍɪᴋᴜ`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "Yoel"
const packname = "𝑯ᴀᴛꜱᴜɴᴇ ᴍɪᴋᴜ"

const chyt = "5492281367797@s.whatsapp.net";
const nit = "5492281367797@s.whatsapp.net";
const supre = "5492281367797@s.whatsapp.net";
