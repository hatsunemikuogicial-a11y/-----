//Base 100% Editable creditos a Hᴀᴛꜱᴜɴᴇ ᴍɪᴋᴜ 

//Página oficial Hᴀᴛꜱᴜɴᴇ ᴍɪᴋᴜ.com
...
const color = (text, color) => { return !color ? chalk.green(text) : chalk.keyword(color)(text) };
 ...
 //baner
const banner = cfonts.render("Hᴀᴛꜱᴜɴᴇ ᴍɪᴋᴜ| Bot| MD", {
  font: 'pallet',
  align: 'center',
  gradient: ["green","blue"]
})
...
async function startProo() {
  ...
  console.log(chalk.cyanBright("🔥 Hᴀᴛꜱᴜɴᴇ ᴍɪᴋᴜ"));
...
await sock.sendMessage(anu.id, {
  image: { url: "https://i.postimg.cc/LscCJhmh/IMG-20260413-WA0880.jpg" },
  caption: sol,
...
✦━─┈༓༒༓┈─━✦
`
  await sock.sendMessage(anu.id,{image : { url : "https://i.postimg.cc/SsLrjrZg/IMG-20260414-WA0061.jpg" }, caption : teks})
    }
...
case 'help': {
    ...
    await sock.sendMessage(from, {
        image: { url: "https://i.postimg.cc/6qyyF6GF/IMG-20260413-WA0878.jpg" },
        caption: Mnu,
        mentions: [sender]
    }, { quoted: info });
}
...
case 'offbot':
  ...
  enviar('😴 ✐ Has *desactivado* a *Hatsune-Miku-Bot
*!* y dejará de responder a los comandos.')
break
...
case 'reiniciar': {
    ...
    enviar('_* Reiniciando a 𝑯𝒂𝒕𝒔𝒖𝒏𝒆-𝑴𝒊𝒌𝒖-𝑩𝒐𝒕*_ ');
    setTimeout(async () => {
...
╚══❖═══════❖══╝
`
sock.sendMessage(from, { image: { url: "https://i.postimg.cc/ncX3GvMm/IMG-20260413-WA0881.jpg" }, caption: botinfo }, { quoted: info })
}
break 
...
➫https://chat.whatsapp.com/KgYJn0FMOhJGsR2FYz7ttw?mode=gi_t`);
break
...
enviar('「 ✅✐ Has *activado* el mensaje de bienvenida! 」')
...
let mentioned = obtenerMencionado(info);
    ...
    if (!mentioned) return enviar("⚠️ 《✧》 Debes mencionar a un usuario para poder expulsarlo del grupo.");

if(mentioned === BotNumber || mentioned === owner) return enviar('🤨')
await sock.groupParticipantsUpdate(from, [mentioned] , 'remove')
enviar('_*usuario eliminado✅️*_')
}
break 
